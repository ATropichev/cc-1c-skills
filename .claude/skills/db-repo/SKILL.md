...
2. если шаг 0 или 1 напечатал «локальная конфигурация изменена: из хранилища получено N» —
...
|----------|--------------|
| `lock -All` | Ничего, но захватывает **всю конфигурацию**: на большой базе идёт долго и блокирует работу всей команде |
