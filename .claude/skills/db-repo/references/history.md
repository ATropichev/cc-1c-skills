...
Короткий отчёт печатается в вывод целиком, длинный — не печатается вовсе: называется путь к файлу
и способы сузить выборку. Обрезанный отчёт по версиям читался бы как полный ответ, и по куску
можно было бы заключить, что объект не менялся.
