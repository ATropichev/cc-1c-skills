---
name: xdto-info
description: Анализ структуры пакета XDTO 1С — типы, свойства, точки входа. Используй для написания кода, создающего и заполняющего объект XDTO, для разбора входящего XML и чтобы понять, какие пакеты есть в конфигурации
...
| `Mode` | нет | `used-by` — кто ссылается на тип. По умолчанию `auto` |
