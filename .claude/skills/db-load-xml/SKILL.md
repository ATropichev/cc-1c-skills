...
Если в записи базы указан `configSrc` — используй как каталог загрузки по умолчанию. Если у базы нет `configSrc`, но есть корневой `configSrc`, используй корневой каталог.
