...
Прочитай `.v8-project.json` из корня проекта и применяй `.v8-project.local.json`, если он существует. Если в итоговой конфигурации задан `webPath` — используй как `-ApachePath`.
