...
**Языки текстов и языки, объявленные в конфигурации, — разные вещи** и совпадать не обязаны: писать текст на языке, которого среди объявленных нет, платформа позволяет. Ориентир при выборе значения — соседние макеты той же конфигурации: внутри конфигурации набор обычно одинаков у всех макетов.
