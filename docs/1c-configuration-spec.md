...
## 7. Различия версий формата 2.17 → 2.18 → 2.19 → 2.20

### 7.1. Лестница версий

Версию формата задаёт **платформа, которой выгружают**; от режима совместимости конфигурации она не зависит. Промежуточных версий не пропускается:
